...
def show_cam_on_image(img, mask, out_dir):
    ...
    swanlab.log({"cam_image":swanlab.Image(path_cam_img)})
    swanlab.log({"cam_image":swanlab.Image(path_raw_img)})
...
if __name__ == '__main__':
    ...
    output_dir = os.path.join(BASE_DIR,  "backward_hook_cam")
    swanlab.init(experiment_name="hook_for_grad_cam")
